!function (t, e) {
    ...
    var ot = Object.freeze({
            ...
            getGeom: rt,
            getType: it
        }), st = Object.getOwnPropertySymbols, at = Object.prototype.hasOwnProperty,
    ...
    */
    ...
    function ye(t, e, n) {
        ...
        var r = K(t), i = rt(e), o = i.type, s = e.bbox, a = i.coordinates;
        if (s && !1 === function (t, e) {
    ...
    function me(t, e, n) {
        void 0 === n && (n = {});
        var r = K(t), i = K(e), o = I(i[1] - r[1]), s = I(i[0] - r[0]), a = I(r[1]), u = I(i[1]),
    ...
    function Me(t, e) {
        ...
        !1 !== n && void 0 !== n || (t = Ie(t));
        var r = [], i = Y(t, (function (t, e) {
            var n = function (t, e) {
                var n, r = t.geometry.coordinates, i = e.geometry.coordinates, o = Le(r[0]), s = Le(r[r.length - 1]),
                    a = Le(i[0]), u = Le(i[i.length - 1]);
    ...
    var Ge = new ArrayBuffer(16), qe = new Float64Array(Ge), Be = new Uint32Array(Ge);
    ...
    function Xe(t) {
        var e, n, r = {};
        for (e in t) r[e] = null == (n = t[e]) ? {type: null} : ("FeatureCollection" === n.type ? Ye : "Feature" === n.type ? He : We)(n);
        return r
    }

    function Ye(t) {
        var e = {type: "GeometryCollection", geometries: t.features.map(He)};
    ...
    function Je(t, e) {
        var n = function (t) {
            ...
            var l = Fe(2 * u * 1.4, ze, ke), c = t.arcs = [];
        ...
        }(t))), o = i.coordinates, s = Fe(1.4 * i.arcs.length, Ze, Ke);
    ...
    function fn(t, e) {
        ...
        for (var n = e.resolution || 1e4, r = e.sharpness || .85, i = [], o = rt(t).coordinates.map((function (t) {
            return {x: t[0], y: t[1]}
        })), s = new pn({duration: n, points: o, sharpness: r}), a = function (t) {
            var e = s.pos(t);
    ...
    function vn(t, e, n, r) {
        void 0 === r && (r = {});
        var i = K(t), o = I(i[0]), s = I(i[1]), u = I(n), l = x(e, r.units),
    ...
    function mn(t, e, n) {
        ...
        var r = K(t), i = K(e), o = I(r[0]), s = I(i[0]), a = I(r[1]), u = I(i[1]), l = Math.sin(s - o) * Math.cos(u),
    ...
    function Un(t, e) {
        var n = new Yn(t.i, t.x, t.y), r = new Yn(e.i, e.x, e.y), i = t.next, o = e.prev;
    ...
    function Wn(t) {
        var e = function (t) {
            ...
            return n
        }(t), n = wn(e.vertices, e.holes, 2), r = [], i = [];
    ...
    Nn.deviation = function (t, e, n, r) {
        var i = e && e.length, o = i ? e[0] * n : t.length, s = Math.abs(Hn(t, 0, o, n));
    ...
    function nr(t, e) {
        er(t, (function (t, n, r, i, o) {
            ...
            switch (a) {
                ...
                case"LineString":
                case"Polygon":
                    return !1 !== e(Kn.feature(t, r, {bbox: i, id: o}), n, 0) && void 0
            }
            switch (a) {
                case"MultiPoint":
                    s = "Point";
    ...
    var or = function (t) {
    ...
    }, sr = Qn, ar = function (t, e, n, r) {
        var i = n;
        return Qn(t, (function (t, r, o, s, a) {
            i = 0 === r && void 0 === n ? t : e(i, t, r, o, s, a)
        }), r), i
    }, ur = tr, lr = function (t, e, n) {
        var r = n;
        ...
        throw new Error("geojson is invalid")
    }, pr = nr, fr = function (t, e, n) {
        var r = n;
        return nr(t, (function (t, i, o) {
            r = 0 === i && 0 === o && void 0 === n ? t : e(r, t, i, o)
        })), r
    }, gr = er, dr = function (t, e, n) {
        var r = n;
        return er(t, (function (t, i, o, s, a) {
            r = 0 === i && void 0 === n ? t : e(r, t, i, o, s, a)
        })), r
    }, yr = ir, vr = function (t, e, n) {
        var r = n;
        return ir(t, (function (t, i, o, s) {
            r = 0 === i && void 0 === n ? t : e(r, t, i, o, s)
        })), r
    }, _r = $n, mr = function (t, e, n) {
        var r = n;
        return $n(t, (function (t, i) {
            r = 0 === i && void 0 === n ? t : e(r, t, i)
        })), r
    }, xr = rr, Er = function (t, e, n) {
        var r = n, i = !1;
    ...
    wr.default = wr;
    var Ir = wr, Nr = Object.defineProperty({default: Ir}, "__esModule", {value: !0}).default, Sr = br.featureEach,
    ...
    function Tr(t, e, n) {
        ...
        return z(t, (function (t) {
            for (var o = Q(t), s = 0; s < o.length - 1; s++) {
                ...
                var c = me(u, l, n), p = Math.max(u.properties.dist, l.properties.dist), f = mn(u, l),
                    g = vn(e, p, f + 90, n), d = vn(e, p, f - 90, n),
    ...
    function Dr(t, e, n) {
        ...
        return U(e, (function (t) {
            var e = t.geometry.coordinates[0], o = t.geometry.coordinates[1], s = function (t, e, n, r) {
                var i = [n[0] - e[0], n[1] - e[1]], o = Fr([t[0] - e[0], t[1] - e[1]], i);
                if (o <= 0) return kr(t, e, {method: r.method, units: "degrees"});
                var s = Fr(i, i);
                if (s <= o) return kr(t, n, {method: r.method, units: "degrees"});
                var a = o / s, u = [e[0] + a * i[0], e[1] + a * i[1]];
                return kr(t, u, {method: r.method, units: "degrees"})
            }(i, e, o, n);
            s < r && (r = s)
        })), N(r, "degrees", n.units)
    }
    ...
    function Jr(t, e, n, r, i) {
        var o = n[0], s = n[1], a = t[0], u = t[1], l = e[0], c = e[1], h = l - a, p = c - u,
            f = (n[0] - a) * p - (n[1] - u) * h;
        if (null !== i) {
    ...
    function Zr(t, e) {
        var n = rt(t), r = rt(e), i = n.type, o = r.type;
        switch (i) {
            case"Point":
                switch (o) {
                    case"MultiPoint":
                    ...
                    case"LineString":
                        return Wr(n, r, {ignoreEndVertices: !0});
                    case"Polygon":
                    case"MultiPolygon":
                    ...
                    case"LineString":
                        return function (t, e) {
                            for (var n = !1, r = 0; r < t.coordinates.length; r++) {
                                ...
                                n || (n = Wr(t.coordinates[r], e, {ignoreEndVertices: !0}))
                            }
                            return n
                        }(n, r);
                    case"Polygon":
                    case"MultiPolygon":
                        return function (t, e) {
                            for (var n = !0, r = !1, i = 0; i < t.coordinates.length; i++) {
                                ...
                                r = ye(t.coordinates[1], e, {ignoreBoundary: !0})
                            }
                            return n && r
                        }(n, r);
                    default:
                    ...
                    case"MultiPolygon":
                        return function (t, e) {
                            ...
                            for (var i = !1, o = 0; o < t.coordinates.length - 1; o++) {
                                ...
                                if (i || (i = ye(t.coordinates[o], e, {ignoreBoundary: !0})), !i) i = ye($r(t.coordinates[o], t.coordinates[o + 1]), e, {ignoreBoundary: !0})
                            }
                            return i
                        }(n, r);
                    default:
    ...
    function oi(t) {
        ...
        var o = n.length, s = ri(t, (function (t, e, n, r, i, o, s, a, u, l, c, h) {
        ...
        for (r = 0; r < h.length; r++) for (g = 0; g < h[r].length; g++) for (_ = 0; _ < h[r][g].length; _++) {
            var x = h[r][g][_].coord, E = (m = v.search({minX: x[0], minY: x[1], maxX: x[0], maxY: x[1]})[0]).index;
        ...
        for (u = []; b.length > 0;) {
            var C = b.pop(), P = C.isect, M = C.parent, L = C.winding, O = u.length, R = [p[P].coord], T = P;
            ...
            R.push(p[D].coord), u.push(l([R], {index: O, parent: M, winding: L, netWinding: void 0}))
        }
        c = f(u);
        ...
        function G() {
            ...
            if (t.length > 1) for (e = 0; e < t.length; e++) {
                for (var n = -1, r = 0; r < c.features.length; r++) t[e] != r && ye(c.features[t[e]].geometry.coordinates[0][0], c.features[r], {ignoreBoundary: !0}) && jr(c.features[r]) < Infinity && (n = r);
    ...
    var pi = Math.PI / 180, fi = 180 / Math.PI, gi = function (t, e) {
    ...
    function mi(t, e) {
        var n = [], r = Q(t)[0], i = Q(t)[t.geometry.coordinates.length - 1];
        if (Ei(r, K(e)) || Ei(i, K(e))) return f([t]);
        var o = Mr(), s = Zn(t);
        o.load(s);
        var a = o.search(e);
        if (!a.features.length) return f([t]);
        var u = xi(e, a), l = k(s, (function (t, r, i) {
            var o = Q(r)[1], s = K(e);
    ...
    function bi(t, e, n, r, i) {
        void 0 === i && (i = {});
        var o = i.steps || 64, s = wi(n), a = wi(r), u = Array.isArray(t) || "Feature" !== t.type ? {} : t.properties;
    ...
    function Ci(t, e) {
        var n, r, i;
        void 0 === e && (e = {});
        var o = e.properties, s = null === (n = e.autoComplete) || void 0 === n || n,
    ...
    function Pi(t, e, n, r) {
        ...
        var i = rt(t), o = i.coordinates, s = i.type;
    ...
    function Gi(t, e) {
        var n = Q(e), r = Q(t), i = r[0], o = r[r.length - 1], s = t.geometry.coordinates;
    ...
    var Ki = {successCallback: null, verbose: !1, polygons: !1}, Qi = {};
    ...
    function $i(t, e, n, r) {
        ...
        return Qi.polygons ? (Qi.verbose && console.log("MarchingSquaresJS-isoBands: returning single polygons for each grid cell"), u = function (t) {
            ...
            for (var e = [], n = t.rows, r = t.cols, i = [], o = 0; o < n; o++) for (var s = 0; s < r; s++) if (void 0 !== t.cells[o][s] && t.cells[o][s].edges.length > 0) {
                var a = Ho(t.cells[o][s]), u = null, l = s, c = o;
    ...
    var to = 64, eo = 16, no = [], ro = [], io = [], oo = [], so = [], ao = [], uo = [], lo = [], co = [], ho = [],
        po = [], fo = [], go = [], yo = [], vo = [], _o = [], mo = [], xo = [], Eo = [], bo = [], wo = [], Io = [],
        No = [], So = [];
    ...
    function Ho(t) {
        if (t.edges.length > 0) {
            ...
            switch (e) {
                case 0:
                    return n & eo ? {p: [1, t.righttop], x: -1, y: 0, o: 1} : {p: [t.topleft, 1], x: 0, y: -1, o: 0};
                case 1:
                ...
                case 4:
                    return n & eo ? {p: [1, t.righttop], x: -1, y: 0, o: 1} : {p: [t.topright, 1], x: 0, y: -1, o: 1};
                case 5:
                ...
                case 11:
                    return n & to ? {p: [1, t.righttop], x: -1, y: 0, o: 1} : {p: [0, t.lefttop], x: 1, y: 0, o: 1};
                case 12:
                ...
                case 15:
                    return n & to ? {p: [1, t.rightbottom], x: -1, y: 0, o: 0} : {p: [0, t.lefttop], x: 1, y: 0, o: 1};
                case 16:
                    return 4 & n ? {p: [t.bottomright, 0], x: 0, y: 1, o: 1} : {p: [0, t.leftbottom], x: 1, y: 0, o: 0};
                case 17:
                    return n & to ? {p: [t.bottomright, 0], x: 0, y: 1, o: 1} : {p: [0, t.lefttop], x: 1, y: 0, o: 1};
                case 18:
                    return 1 & n ? {p: [0, t.leftbottom], x: 1, y: 0, o: 0} : {p: [t.bottomleft, 0], x: 0, y: 1, o: 0};
                case 19:
                    return n & to ? {p: [t.bottomleft, 0], x: 0, y: 1, o: 0} : {p: [0, t.lefttop], x: 1, y: 0, o: 1};
                case 20:
                    return n & to ? {p: [t.topleft, 1], x: 0, y: -1, o: 0} : {p: [0, t.leftbottom], x: 1, y: 0, o: 0};
                case 21:
                    return n & eo ? {p: [0, t.leftbottom], x: 1, y: 0, o: 0} : {p: [t.topright, 1], x: 0, y: -1, o: 1};
                case 22:
                    return n & to ? {p: [t.topleft, 1], x: 0, y: -1, o: 0} : {p: [0, t.lefttop], x: 1, y: 0, o: 1};
                case 23:
                    return n & eo ? {p: [0, t.lefttop], x: 1, y: 0, o: 1} : {p: [t.topright, 1], x: 0, y: -1, o: 1};
                default:
    ...
    function $o(t, e, n) {
        ...
        return 0 === e || (r || (r = En(t)), !1 !== i && void 0 !== i || (t = Ie(t)), R(t, (function (t) {
            var n = Bi(r, t) + e, i = Ar(r, t), o = Q(ji(r, i, n));
            t[0] = o[0], t[1] = o[1]
        }))), t
    }
    ...
    function es(t, e, n) {
        ...
        return n = function (t, e) {
            ...
            var n = t.bbox ? t.bbox : Z(t), r = n[0], i = n[1], o = n[2], s = n[3];
            switch (e) {
                case"sw":
                case"southwest":
                case"westsouth":
            ...
            var r = Ar(n, t), i = Bi(n, t), o = Q(ji(n, r * e, i));
    ...
    var Ms = Bt((function (t) {
        ...
        t.exports && (t.exports = {DBSCAN: Ms, KMEANS: Ls, OPTICS: Rs, PriorityQueue: Os})
    }));
    var As = function (t, e, n) {
    ...
    }, Ds = As, Fs = function (t, e, n) {
        var r = Math.abs(t - e);
        return n ? r : r * r
    }, ks = As, Gs = function (t, e) {
        ...
        var n = t[0].length ? Ds : Fs, r = [], i = t.length, o = t[0].length > 0, s = t[Math.floor(Math.random() * i)];
        o && s.join("_");
    ...
    var Xs = {
        search: function (t, e, n, r) {
            t.cleanDirty();
            var i = (r = r || {}).heuristic || Xs.heuristics.manhattan, o = r.closest || !1, s = new Ws((function (t) {
                return t.f
            })), a = e;
    ...
    Ys.prototype.init = function () {
        ...
        constructor: $s, insert: function (t, e) {
            var n, r, i;
            if (t) {
    ...
    function Aa(t, e, n, r) {
        ...
        var c = K(t);
        if ("degrees" === o) var h = I(s); else e = ji(t, e, 90, {units: o}), n = ji(t, n, 0, {units: o}), e = K(e)[0] - c[0], n = K(n)[1] - c[1];
        for (var p = [], f = 0; f < i; f += 1) {
            var g = -360 * f / i, d = e * n / Math.sqrt(Math.pow(n, 2) + Math.pow(e, 2) * Math.pow(Da(g), 2)),
        ...
        return p.push(p[0]), "degrees" === o ? l([p], u) : $o(l([p], u), s, {pivot: a})
    }
    ...
    function ka(t, e, n, r, i) {
        var o = r.tolerance || .001, s = 0, u = 0, l = 0, c = 0;
        if (F(n, (function (e) {
        ...
        var h = s / l, p = u / l;
        return 1 === c || 0 === i || Math.abs(h - e[0]) < o && Math.abs(p - e[1]) < o ? a([h, p], {medianCandidates: r.medianCandidates}) : (r.medianCandidates.push([h, p]), ka([h, p], t, n, r, i - 1))
    }
    ...
    function za(t, e, n) {
        void 0 === n && (n = 2);
        var r = K(t), i = K(e), o = r[0] - i[0], s = r[1] - i[1];
    ...
    Ra.prototype = {
        constructor: Ra, polygons: function () {
            var t = this.edges;
    ...
    var Ja = Object.freeze({__proto__: null, toMercator: Va, toWgs84: Xa}), Za = function () {
    ...
    var _u = function () {
        ...
        return t.prototype.insert = function (t, e) {
            ...
            var r = this._comparator, i = gu(t, this._root, r), o = r(t, i.key);
            ...
            return function (t) {
                var e = t, n = [], r = !1, i = new pu(null, null), o = i;
            ...
            if (n && Eu(t, e, 0, r - 1, i), null === this._root) this._root = mu(t, e, 0, r), this._size = r; else {
                var o = function (t, e, n) {
                    var r = new pu(null, null), i = r, o = t, s = e;
            ...
            var r = this._comparator, i = yu(t, this._root, r), o = i.left, s = i.right;
    ...
    function mu(t, e, n, r) {
        var i = r - n;
        if (i > 0) {
            var o = n + Math.floor(i / 2), s = t[o], a = e[o], u = new pu(s, a);
    ...
    function xu(t, e, n) {
        var r = n - e;
        if (r > 0) {
            var i = e + Math.floor(r / 2), o = xu(t, e, i), s = t.head;
    ...
    var Pu = Cu * Cu, Mu = function (t, e) {
        ...
        }(), Ru = new Lu, Tu = function (t, e) {
            return t.x * e.y - t.y * e.x
        }, Au = function (t, e) {
            return t.x * e.x + t.y * e.y
        }, Du = function (t, e, n) {
            var r = {x: e.x - t.x, y: e.y - t.y}, i = {x: n.x - t.x, y: n.y - t.y}, o = Tu(r, i);
            return Mu(o, 0)
        }, Fu = function (t) {
                    ...
                    var e = this, n = new Map, r = function (r) {
                        ...
                        n.set(r, {
                            sine: (i = e.point, o = t.point, s = l.point, a = {
                                x: o.x - i.x,
                                y: o.y - i.y
                            }, u = {x: s.x - i.x, y: s.y - i.y}, Tu(u, a) / Fu(u) / Fu(a)),
            ...
            return Iu(t, null, [{
                ...
                key: "getIntersection", value: function (t) {
                    var e = this.bbox(), n = t.bbox(), r = Su(e, n);
                    if (null === r) return null;
                    var i = this.leftSE.point, o = this.rightSE.point, s = t.leftSE.point, a = t.rightSE.point,
                        u = Nu(e, s) && 0 === this.comparePoint(s), l = Nu(n, i) && 0 === t.comparePoint(i),
                        c = Nu(e, a) && 0 === this.comparePoint(a), h = Nu(n, o) && 0 === t.comparePoint(o);
                    ...
                    var p = function (t, e, n, r) {
                        ...
                        var i = Tu(e, r);
                        if (0 == i) return null;
                        var o = {x: n.x - t.x, y: n.y - t.y}, s = Tu(o, e) / i, a = Tu(o, r) / i;
                ...
                key: "split", value: function (e) {
                    var n = [], r = void 0 !== e.events, i = new Bu(e, !0), o = new Bu(e, !1), s = this.rightSE;
    ...
    ul.prototype.setOrdinate = function (t, e) {
        ...
        if (1 === arguments.length) {
            var t = arguments[0], e = nl.doubleToLongBits(t);
    ...
    cl.prototype.compare = function (t, e) {
        var n = t, r = e, i = cl.compare(n.x, r.x);
        if (0 !== i) return i;
    ...
    xl.prototype.le = function (t) {
        ...
        var n = this.abs(), r = xl.magnitude(n._hi), i = xl.TEN.pow(r);
        ...
        var e = new xl(this), n = xl.valueOf(1), r = Math.abs(t);
        ...
        var t = 1 / Math.sqrt(this._hi), e = this._hi * t, n = xl.valueOf(e), r = this.subtract(n.sqr())._hi * (.5 * t);
        return n.add(r)
        ...
        var t = this.getSpecialNumberString();
        if (null !== t) return t;
        var e = new Array(1).fill(null), n = this.extractSignificantDigits(!1, e), r = xl.SCI_NOT_EXPONENT_CHAR + e[0];
    ...
    var bl = function () {
    }, wl = {DP_SAFE_EPSILON: {configurable: !0}};
    bl.prototype.interfaces_ = function () {
        ...
        if (r <= 1) return r;
        var i = xl.valueOf(e.x).selfAdd(-t.x), o = xl.valueOf(e.y).selfAdd(-t.y), s = xl.valueOf(n.x).selfAdd(-e.x),
        ...
        var i = xl.valueOf(r.y).selfSubtract(n.y).selfMultiply(xl.valueOf(e.x).selfSubtract(t.x)),
            o = xl.valueOf(r.x).selfSubtract(n.x).selfMultiply(xl.valueOf(e.y).selfSubtract(t.y)), s = i.subtract(o),
    ...
    var Il = function () {
    }, Nl = {X: {configurable: !0}, Y: {configurable: !0}, Z: {configurable: !0}, M: {configurable: !0}};
    Nl.X.get = function () {
        return 0
    }, Nl.Y.get = function () {
        return 1
    ...
    }, Ol = {serialVersionUID: {configurable: !0}};
    ...
    var jl = function (t) {
        ...
        return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.isInSegmentEnvelopes = function (t) {
            ...
            var o = bl.intersection(t, e, n, r), s = this.isInSegmentEnvelopes(o);
            ...
            var i = new ul(t), o = new ul(e), s = new ul(n), a = new ul(r), u = new ul;
            ...
            var o = Xl.orientationIndex(e, n, r), s = Xl.orientationIndex(e, n, i);
            if (o > 0 && s > 0 || o < 0 && s < 0) return t.NO_INTERSECTION;
            var a = Xl.orientationIndex(r, i, e), u = Xl.orientationIndex(r, i, n);
            ...
            var i = t, o = Xl.distancePointLine(t, n, r), s = Xl.distancePointLine(e, n, r);
    ...
    Xl.prototype.interfaces_ = function () {
        ...
        if (gl(arguments[0], Il)) {
            ...
            if (u < 3) return 0;
            var l = new ul, c = new ul, h = new ul;
        ...
        var c = Xl.computeOrientation(u, n, l), h = !1;
    ...
    }, oc.prototype = new Error, oc.prototype.name = "IndexOutOfBoundsException";
    var sc = function () {
    };
    ...
    var kc = function (t) {
        ...
        return e.prototype.computeEnvelopeInternal = function () {
            ...
            var t = this;
            if (1 === arguments.length) {
                var e = arguments[0], n = new Lc(Rc.asList(this._geometries)), r = new Lc(Rc.asList(e._geometries));
        ...
        if (this._geom = null, this._geomFact = null, this._bnRule = null, this._endpointMap = null, 1 === arguments.length) {
            var t = arguments[0], e = Ql.MOD2_BOUNDARY_RULE;
    ...
    qc.prototype.boundaryMultiLineString = function (t) {
        ...
        if (1 === arguments.length) {
            var t = arguments[0], e = new qc(t);
            return e.getBoundary()
        }
        if (2 === arguments.length) {
            var n = arguments[0], r = arguments[1], i = new qc(n, r);
    ...
    var Hc = function () {
    }, Wc = {NEWLINE: {configurable: !0}, SIMPLE_ORDINATE_FORMAT: {configurable: !0}};
    Hc.prototype.interfaces_ = function () {
        ...
        if (1 === arguments.length) {
            var t = arguments[0], e = new Vc, n = new zc(e);
    ...
    var hh = function () {
    }, ph = {serialVersionUID: {configurable: !0}, instanceObject: {configurable: !0}};
    ...
    }, dh = {serialVersionUID: {configurable: !0}, maximumPreciseValue: {configurable: !0}};
    ...
    }, vh = {serialVersionUID: {configurable: !0}, nameToTypeMap: {configurable: !0}};
    ...
    var xh = ["Point", "MultiPoint", "LineString", "MultiLineString", "Polygon", "MultiPolygon"], Eh = function (t) {
        this.geometryFactory = t || new _h
    };
    ...
    var bh = {
        Feature: function (t) {
            ...
            for (var e = bh.coordinates.apply(this, [t[0]]), n = this.geometryFactory.createLinearRing(e), r = [], i = 1; i < t.length; ++i) {
                var o = t[i], s = bh.coordinates.apply(this, [o]), a = this.geometryFactory.createLinearRing(s);
                r.push(a)
            }
    ...
    Lh.prototype.getCoordinate = function () {
        ...
        var e = t[this._minIndex - 1], n = t[this._minIndex + 1], r = Xl.computeOrientation(this._minCoord, n, e),
            i = !1;
    ...
    Th.prototype.clearVisitedEdges = function () {
        ...
        var e = new xc, n = new Rh, r = t.getNode();
    ...
    Fh.prototype.computeRing = function () {
        ...
        if (1 === arguments.length) {
            ...
            var e = arguments[0], n = arguments[1], r = e.getLocation(n, Sh.RIGHT);
    ...
    var jh = function () {
    }, Uh = {NE: {configurable: !0}, NW: {configurable: !0}, SW: {configurable: !0}, SE: {configurable: !0}};
    ...
    Wh.prototype.sortShellsAndHoles = function (t, e, n) {
        ...
        if (1 === arguments.length) {
            ...
            var r = this.buildMaximalEdgeRings(e), i = new lc, o = this.buildMinimalEdgeRings(r, this._shellList, i);
    ...
    }, ep = {serialVersionUID: {configurable: !0}};
    ...
    rp.prototype.expandToQueue = function (t, e) {
        var n = rp.isComposite(this._boundable1), r = rp.isComposite(this._boundable2);
        ...
        for (var i = t.getChildBoundables().iterator(); i.hasNext();) {
            var o = i.next(), s = new rp(o, e, this._itemDistance);
    ...
    var up = function (t) {
        ...
        return e.prototype.createParentBoundablesFromVerticalSlices = function (t, e) {
            ...
            ql.isTrue(!t.isEmpty());
            var r = Math.trunc(Math.ceil(t.size() / this.getNodeCapacity())), i = new lc(t);
            ...
            if (1 === arguments.length) {
                if (gl(arguments[0], ap)) {
                    var t = arguments[0], n = new rp(this.getRoot(), this.getRoot(), t);
                ...
                if (arguments[0] instanceof e && gl(arguments[1], ap)) {
                    var i = arguments[0], o = arguments[1], s = new rp(this.getRoot(), i.getRoot(), o);
                    return this.nearestNeighbour(s)
                }
                if (arguments[0] instanceof rp && "number" == typeof arguments[1]) {
                    var a = arguments[0], u = arguments[1], l = u, c = null, h = new Kh;
                ...
                var g = arguments[0], d = arguments[1], y = arguments[2], v = new Zh(g, d),
    ...
    cp.prototype.interfaces_ = function () {
        ...
        var r = cp.relativeSign(e.x, n.x), i = cp.relativeSign(e.y, n.y);
        switch (t) {
            case 0:
    ...
    pp.prototype.getSplitCoordinates = function () {
        ...
        var n = new hp(this._edge, t, e, this._edge.getSegmentOctant(e)), r = this._nodeMap.get(n);
    ...
    yp.prototype.getCoordinates = function () {
        ...
        if (2 === arguments.length) {
            ...
            var n = arguments[0], r = arguments[1], i = arguments[3], o = new ul(n.getIntersection(i));
    ...
    vp.prototype.minX = function () {
        ...
        if (arguments[0] instanceof ul) {
            ...
            var e = this.projectionFactor(t), n = new ul;
        ...
        var n = new Array(2).fill(null), r = nl.MAX_VALUE, i = null, o = this.closestPoint(t.p0);
        ...
        var e = Math.trunc(t) ^ Math.trunc(t >> 32), n = nl.doubleToLongBits(this.p1.x);
    ...
    }, Op = {COORDINATE_ARRAY_TYPE: {configurable: !0}};
    Lp.prototype.getCoordinates = function () {
        ...
        var t = new ul(this._ptList.get(0)), e = this._ptList.get(this._ptList.size() - 1);
    ...
    Rp.prototype.interfaces_ = function () {
        ...
        var r = Rp.angle(e, t), i = Rp.angle(e, n);
        return Math.abs(i - r)
        ...
        var r = Rp.angle(e, t), i = Rp.angle(e, n) - r;
    ...
    Ap.prototype.addNextSegment = function (t, e) {
        ...
        switch (this._bufParams.getEndCapStyle()) {
            ...
            case Sp.CAP_SQUARE:
                ...
                var l = new ul(r.p1.x + u.x, r.p1.y + u.y), c = new ul(i.p1.x + u.x, i.p1.y + u.y);
        ...
        var i = this._seg0.p1, o = Rp.angle(i, this._seg0.p0),
            s = Rp.angleBetweenOriented(this._seg0.p0, i, this._seg1.p1) / 2, a = Rp.normalize(o + s),
            u = Rp.normalize(a + Math.PI), l = r * n, c = n - l * Math.abs(Math.sin(s)), h = i.x + l * Math.cos(u),
            p = i.y + l * Math.sin(u), f = new ul(h, p), g = new vp(i, f), d = g.pointAlongOffset(1, c),
        ...
        var i = e === Sh.LEFT ? 1 : -1, o = t.p1.x - t.p0.x, s = t.p1.y - t.p0.y, a = Math.sqrt(o * o + s * s),
            u = i * n * o / a, l = i * n * s / a;
        r.p0.x = t.p0.x - l, r.p0.y = t.p0.y + u, r.p1.x = t.p1.x - l, r.p1.y = t.p1.y + u
    }, Ap.prototype.addFilletArc = function (t, e, n, r, i) {
        var o = r === Xl.CLOCKWISE ? -1 : 1, s = Math.abs(e - n), a = Math.trunc(s / this._filletAngleQuantum + .5);
        if (a < 1) return null;
    ...
    var kp = function () {
        ...
        var t = arguments[0];
        this._subgraphs = t
    }, Gp = {DepthSegment: {configurable: !0}};
    ...
    Bp.prototype.area = function () {
        ...
        var r = n.x, i = n.y, o = t.x - r, s = t.y - i, a = e.x - r, u = e.y - i, l = 2 * Bp.det(o, s, a, u),
            c = Bp.det(s, o * o + s * s, u, a * a + u * u), h = Bp.det(o, o * o + s * s, a, a * a + u * u);
        return new ul(r - c / l, i + h / l)
    }, Bp.perpendicularBisector = function (t, e) {
        var n = e.x - t.x, r = e.y - t.y, i = new Ml(t.x + n / 2, t.y + r / 2, 1),
    ...
    zp.prototype.addPoint = function (t) {
        ...
        var e = this, n = this._distance, r = Sh.LEFT;
        this._distance < 0 && (n = -this._distance, r = Sh.RIGHT);
        var i = t.getExteriorRing(), o = pc.removeRepeatedPoints(i.getCoordinates());
        ...
        for (var s = 0; s < t.getNumInteriorRing(); s++) {
            var a = t.getInteriorRingN(s), u = pc.removeRepeatedPoints(a.getCoordinates());
        ...
        var n = new Bp(t[0], t[1], t[2]), r = n.inCentre();
        ...
        var e = pc.removeRepeatedPoints(t.getCoordinates()), n = this._curveBuilder.getLineCurve(e, this._distance);
        this.addCurve(n, pl.EXTERIOR, pl.INTERIOR)
    ...
    Xp.prototype.getNextCW = function (t) {
        ...
        for (var i = e, o = this.iterator(); o.hasNext();) {
            ...
            if (a.getLocation(t, Sh.ON) === pl.NONE && a.setLocation(t, Sh.ON, i), a.isArea(t)) {
                var u = a.getLocation(t, Sh.LEFT), l = a.getLocation(t, Sh.RIGHT);
                if (l !== pl.NONE) {
        ...
        var n = e.size() - 1, r = e.get(n).getLabel().getLocation(t, Sh.LEFT);
        ...
        for (var i = r, o = this.iterator(); o.hasNext();) {
            ...
            var a = s.getLocation(t, Sh.LEFT), u = s.getLocation(t, Sh.RIGHT);
            if (a === u) return !1;
            if (u !== i) return !1;
            i = a
        }
    ...
    var Yp = function (t) {
        ...
        return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.linkResultDirectedEdges = function () {
            ...
            var t = this;
            if (1 === arguments.length) {
                var e = arguments[0], n = this.findIndex(e), r = e.getDepth(Sh.LEFT), i = e.getDepth(Sh.RIGHT),
    ...
    $p.prototype.print = function (t) {
        ...
        var r = new Qp(t, e, n), i = this._nodeMap.get(r);
    ...
    var of = function (t) {
        ...
        return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.getDepth = function () {
            ...
            var i = new ul(t.getIntersection(r)), o = e, s = t.getEdgeDistance(n, r), a = o + 1;
    ...
    sf.prototype.setWorkingPrecisionModel = function (t) {
        ...
        if (null !== e) {
            ...
            var i = sf.depthDelta(r), o = e.getDepthDelta() + i;
            e.setDepthDelta(o)
        ...
        for (var n = new lc, r = t.iterator(); r.hasNext();) {
            var i = r.next(), o = i.getRightmostCoordinate(), s = new kp(n).getDepth(o);
        ...
        var r = new Fp(n, this._bufParams), i = new zp(t, e, r).getCurves();
        ...
        var o = this.createSubgraphs(this._graph), s = new Wh(this._geomFact);
        ...
        for (var r = n.getNodedSubstrings().iterator(); r.hasNext();) {
            ...
            if (2 !== o.length || !o[0].equals2D(o[1])) {
                var s = i.getData(), a = new of(i.getCoordinates(), new Dh(s));
        ...
        var e = t.getLocation(0, Sh.LEFT), n = t.getLocation(0, Sh.RIGHT);
    ...
    }, hf = {SAFE_ENV_EXPANSION_FACTOR: {configurable: !0}};
    ...
    var ff = function () {
        ...
        var t = arguments[0];
        this._index = t
    }, gf = {HotPixelSnapAction: {configurable: !0}};
    ff.prototype.snap = function () {
        ...
        if (3 === arguments.length) {
            var e = arguments[0], n = arguments[1], r = arguments[2], i = e.getSafeEnvelope(), o = new df(e, n, r);
    ...
    vf.prototype.checkCorrectness = function (t) {
        var e = yp.getNodedSubstrings(t), n = new uf(e);
        try {
            n.checkValid()
        } catch (t) {
        ...
        if (gl(arguments[0], ic)) for (var e = arguments[0], n = e.iterator(); n.hasNext();) {
            ...
            var a = new cf(o[s], t._scaleFactor, t._li), u = t._pointSnapper.snap(a, i, s);
        ...
        for (var e = this, n = t.iterator(); n.hasNext();) {
            var r = n.next(), i = new cf(r, e._scaleFactor, e._li);
    ...
    _f.prototype.bufferFixedPrecision = function (t) {
        var e = new af(new vf(new gh(1)), t.getScale()), n = new sf(this._bufParams);
        ...
        if (1 === arguments.length) {
            var n = arguments[0], r = _f.precisionScaleFactor(this._argGeom, this._distance, n), i = new gh(r);
        ...
        if (2 === arguments.length) {
            var t = arguments[0], e = arguments[1], n = new _f(t), r = n.getResultGeometry(e);
            return r
        }
        if (3 === arguments.length) {
            if (Number.isInteger(arguments[2]) && arguments[0] instanceof Wl && "number" == typeof arguments[1]) {
                var i = arguments[0], o = arguments[1], s = arguments[2], a = new _f(i);
            ...
            if (arguments[2] instanceof Sp && arguments[0] instanceof Wl && "number" == typeof arguments[1]) {
                var l = arguments[0], c = arguments[1], h = arguments[2], p = new _f(l, h), f = p.getResultGeometry(c);
                return f
            }
        } else if (4 === arguments.length) {
            var g = arguments[0], d = arguments[1], y = arguments[2], v = arguments[3], _ = new _f(g);
    ...
    }, wf = {MaxPointDistanceFilter: {configurable: !0}, MaxMidpointDistanceFilter: {configurable: !0}};
    ...
    Nf.prototype.filter = function (t, e) {
        if (0 === e) return null;
        var n = t.getCoordinate(e - 1), r = t.getCoordinate(e), i = new ul((n.x + r.x) / 2, (n.y + r.y) / 2);
    ...
    Cf.prototype.filter = function (t) {
        ...
        if (2 === arguments.length) {
            ...
            if (arguments[0] instanceof Wl && "boolean" == typeof arguments[1]) {
                var o = arguments[0], s = arguments[1], a = new lc;
    ...
    Tf.prototype.computeContainmentDistance = function () {
        ...
        if (0 === arguments.length) {
            ...
            var n = arguments[0], r = arguments[1], i = 1 - n, o = Sf.getPolygons(this._geom[n]);
            if (o.size() > 0) {
        ...
        var t = new Array(2).fill(null), e = Cf.getLines(this._geom[0]), n = Cf.getLines(this._geom[1]),
            r = Of.getPoints(this._geom[0]), i = Of.getPoints(this._geom[1]);
        ...
        if (0 === arguments.length) {
            ...
            for (var i = e.getCoordinates(), o = n.getCoordinate(), s = 0; s < i.length - 1; s++) {
                ...
                if (a < t._minDistance) {
                    t._minDistance = a;
                    var u = new vp(i[s], i[s + 1]), l = u.closestPoint(o);
            ...
            for (var f = c.getCoordinates(), g = h.getCoordinates(), d = 0; d < f.length - 1; d++) for (var y = 0; y < g.length - 1; y++) {
                ...
                if (v < t._minDistance) {
                    t._minDistance = v;
                    var _ = new vp(f[d], f[d + 1]), m = new vp(g[y], g[y + 1]), x = _.closestPoints(m);
    ...
    }, kf = {MaxPointDistanceFilter: {configurable: !0}, MaxDensifiedByFractionDistanceFilter: {configurable: !0}};
    Ff.prototype.getCoordinates = function () {
        ...
        if (2 === arguments.length) {
            var t = arguments[0], e = arguments[1], n = new Ff(t, e);
            return n.distance()
        }
        if (3 === arguments.length) {
            var r = arguments[0], i = arguments[1], o = arguments[2], s = new Ff(r, i);
    ...
    qf.prototype.filter = function (t, e) {
        ...
        for (var r = t.getCoordinate(e - 1), i = t.getCoordinate(e), o = (i.x - r.x) / this._numSubSegs, s = (i.y - r.y) / this._numSubSegs, a = 0; a < this._numSubSegs; a++) {
            var u = r.x + a * o, l = r.y + a * s, c = new ul(u, l);
    ...
    }, zf = {VERBOSE: {configurable: !0}, MAX_DISTANCE_DIFF_FRAC: {configurable: !0}};
    Bf.prototype.checkMaximumDistance = function (t, e, n) {
        ...
        var t = Math.abs(this._bufDistance), e = Bf.MAX_DISTANCE_DIFF_FRAC * t;
    ...
    }, Uf = {VERBOSE: {configurable: !0}, MAX_ENV_DIFF_FRAC: {configurable: !0}};
    ...
    }, tg = {SNAP_PRECISION_FACTOR: {configurable: !0}};
    $f.prototype.snapTo = function (t, e) {
        ...
        var n = this.extractTargetCoordinates(this._srcGeom), r = new eg(t, n, !0).transform(this._srcGeom), i = r;
        ...
        var r = new Array(2).fill(null), i = new $f(t);
        r[0] = i.snapTo(e, n);
        var o = new $f(e);
        return r[1] = o.snapTo(r[0], n), r
    }, $f.computeOverlaySnapTolerance = function () {
        if (1 === arguments.length) {
            var t = arguments[0], e = $f.computeSizeBasedSnapTolerance(t), n = t.getPrecisionModel();
    ...
    ng.prototype.getCommon = function () {
        ...
        if (1 === arguments.length) {
            var t = arguments[0], e = nl.longBitsToDouble(t), n = nl.toBinaryString(t),
    ...
    }, ig = {CommonCoordinateFilter: {configurable: !0}, Translater: {configurable: !0}};
    ...
    ag.prototype.selfSnap = function (t) {
        ...
        var e = this.snap(this._geom), n = Mg.overlayOp(e[0], e[1], t);
    ...
    }, hg = {INSERT: {configurable: !0}, DELETE: {configurable: !0}};
    ...
    var gg = function (t) {
        ...
        return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.prepareEvents = function () {
            ...
            for (var n = t.getMonotoneChainEdge(), r = n.getStartIndexes(), i = 0; i < r.length - 1; i++) {
                var o = new lg(n, i), s = new cg(e, n.getMinX(i), o);
    ...
    }, yg = {NodeComparator: {configurable: !0}};
    ...
    }, wg = {SegmentVisitor: {configurable: !0}, IntervalIndexedGeometry: {configurable: !0}};
    bg.prototype.locate = function (t) {
        var e = new Vl(t), n = new Ig(e);
    ...
    Ng.prototype.init = function (t) {
        ...
        for (var e = 1; e < t.length; e++) {
            var n = new vp(t[e - 1], t[e]), r = Math.min(n.p0.y, n.p1.y), i = Math.max(n.p0.y, n.p1.y);
            this._index.insert(r, i, n)
        }
    }, Ng.prototype.query = function () {
        if (2 === arguments.length) {
            var t = arguments[0], e = arguments[1], n = new Eg;
    ...
    var Sg = function (t) {
        function e() {
            if (t.call(this), this._parentGeom = null, this._lineEdgeMap = new fh, this._boundaryNodeRule = null, this._useBoundaryDeterminationRule = !0, this._argIndex = null, this._boundaryNodes = null, this._hasTooFewPoints = !1, this._invalidPoint = null, this._areaPtLocator = null, this._ptLocator = new Pf, 2 === arguments.length) {
                var e = arguments[0], n = arguments[1], r = Ql.OGC_SFS_BOUNDARY_RULE;
        ...
        return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.insertBoundaryPoint = function (t, n) {
            ...
            if (3 === arguments.length) {
                var n = arguments[0], r = arguments[1], i = arguments[2], o = new fg(n, !0, !1);
    ...
    Tg.prototype.reportResult = function (t, e, n) {
        ...
        var n = Mg.isResultOfOp(e[0], e[1], t), r = !(n ^ e[2] === pl.INTERIOR);
    ...
    Dg.prototype.extractElements = function (t, e) {
        ...
        if (1 === arguments.length) {
            var t = arguments[0], e = new Dg(t);
            return e.combine()
        }
        if (2 === arguments.length) {
            var n = arguments[0], r = arguments[1], i = new Dg(Dg.createList(n, r));
            return i.combine()
        }
        if (3 === arguments.length) {
            var o = arguments[0], s = arguments[1], a = arguments[2], u = new Dg(Dg.createList(o, s, a));
            return u.combine()
        }
        ...
        if (2 === arguments.length) {
            var t = arguments[0], e = arguments[1], n = new lc;
            return n.add(t), n.add(e), n
        }
        if (3 === arguments.length) {
            var r = arguments[0], i = arguments[1], o = arguments[2], s = new lc;
    ...
    }, kg = {STRTREE_NODE_CAPACITY: {configurable: !0}};
    Fg.prototype.reduceToGeometries = function (t) {
        ...
        var r = new lc, i = this.extractByEnvelope(n, t, r), o = this.extractByEnvelope(n, e, r),
    ...
    var Ug = 1e-6, Vg = Math.PI, Xg = Vg / 2, Yg = Vg / 4, Hg = 2 * Vg, Wg = 180 / Vg, Jg = Vg / 180, Zg = Math.abs,
        Kg = Math.atan, Qg = Math.atan2, $g = Math.cos, td = Math.sin, ed = Math.sqrt;
    ...
    function Ed(t, e) {
        var n = $g(t), r = td(t), i = $g(e), o = td(e);

        function s(t, e) {
            var s = $g(e), a = $g(t) * s, u = td(t) * s, l = td(e), c = l * n + a * r;
            return [Qg(u * i - c * o, a * n - l * r), rd(c * i + u * o)]
        }

        return s.invert = function (t, e) {
            var s = $g(e), a = $g(t) * s, u = td(t) * s, l = td(e), c = l * i - u * o;
    ...
    qg(), qg();
    var kd = 1 / 0, Gd = kd, qd = -kd, Bd = qd, zd = {
        point: function (t, e) {
            t < kd && (kd = t);
            t > qd && (qd = t);
            e < Gd && (Gd = e);
            e > Bd && (Bd = e)
        }, lineStart: id, lineEnd: id, polygonStart: id, polygonEnd: id, result: function () {
            var t = [[kd, Gd], [qd, Bd]];
        ...
        return function (i, o) {
            var s, a, u, l = e(o), c = i.invert(r[0], r[1]), h = wd(), p = e(h), f = !1, g = {
                point: d, lineStart: v, lineEnd: _, polygonStart: function () {
                    ...
                    var t = function (t, e) {
                        var n = e[0], r = e[1], i = [td(n), -$g(n), 0], o = 0, s = 0;
                        Dd.reset();
                        for (var a = 0, u = t.length; a < u; ++a) if (c = (l = t[a]).length) for (var l, c, h = l[c - 1], p = h[0], f = h[1] / 2 + Yg, g = td(f), d = $g(f), y = 0; y < c; ++y, p = _, g = x, d = E, h = v) {
                            var v = l[y], _ = v[0], m = v[1] / 2 + Yg, x = td(m), E = $g(m), b = _ - p,
                                w = b >= 0 ? 1 : -1, I = w * b, N = I > Vg, S = g * x;
    ...
    function Yd(t, e) {
        ...
        function s(t, e, r) {
            var i = [1, 0, 0], o = fd(hd(t), hd(e)), s = pd(o, o), a = o[0], u = s - a * a;
            if (!u) return !r && t;
            var l = n * s / u, c = -n * a / u, h = fd(i, o), p = dd(i, l);
            gd(p, dd(o, c));
            var f = h, g = pd(p, f), d = pd(f, f), y = g * g - d * (pd(p, p) - 1);
            if (!(y < 0)) {
                var v = ed(y), _ = dd(f, (-g - v) / d);
                if (gd(_, p), _ = cd(_), !r) return _;
                var m, x = t[0], E = e[0], b = t[1], w = e[1];
                E < x && (m = x, x = E, E = m);
                var I = E - x, N = Zg(I - Vg) < Ug;
    ...
    function Kd(t, e) {
        return +e ? function (t, e) {
            function n(r, i, o, s, a, u, l, c, h, p, f, g, d, y) {
                ...
                if (m > 4 * e && d--) {
                    var x = s + p, E = a + f, b = u + g, w = ed(x * x + E * E + b * b), I = rd(b /= w),
                        N = Zg(Zg(b) - 1) < Ug || Zg(o - h) < Ug ? (o + h) / 2 : Qg(E, x), S = t(N, I), C = S[0],
                        P = S[1], M = C - r, L = P - i, O = _ * M - v * L;
    ...
    function ny(t, n, r, i) {
        ...
        var l = function (t) {
                var n = xn(t).geometry.coordinates, r = [-n[0], -n[1]];
                return ey().rotate(r).scale(e)
            }(a), c = {type: a.type, coordinates: iy(a.coordinates, l)}, h = (new Ih).read(c), p = m(x(n, r), "meters"),
            g = _f.bufferOp(h, p, i);
        if (!ry((g = (new Nh).write(g)).coordinates)) return o({type: g.type, coordinates: oy(g.coordinates, l)}, s)
    }
    ...
    function sy(t, e, n) {
        void 0 === n && (n = {});
        var r = rt(t), i = rt(e), o = $u.intersection(r.coordinates, i.coordinates);
    ...
    ty.invert = function (t) {
        return function (e, n) {
            var r = ed(e * e + n * n), i = t(r), o = td(i), s = $g(i);
        ...
        var i = t, o = e, s = n, a = b(!0 !== r.mercator ? mn(i, o) : Bi(i, o)),
            u = b(!0 !== r.mercator ? mn(s, o) : Bi(s, o)), l = Math.abs(a - u);
        return !0 === r.explementary ? 360 - l : l
    }, t.applyFilter = uu, t.area = jr, t.areaFactors = i, t.bbox = Z, t.bboxClip = function (t, e) {
        var n = rt(t), r = n.type, i = "Feature" === t.type ? t.properties : {}, o = n.coordinates;
        switch (r) {
            case"LineString":
            case"MultiLineString":
                var s = [];
        ...
        var n = rt(t), r = rt(e), i = n.type, o = r.type, s = n.coordinates, a = r.coordinates;
        switch (i) {
            case"Point":
                switch (o) {
                    case"Point":
            ...
            case"LineString":
                switch (o) {
                    case"Point":
                        return Wr(r, n, {ignoreEndVertices: !0});
                    case"LineString":
                        return function (t, e) {
                    ...
                    case"MultiPoint":
                        return function (t, e) {
                            for (var n = !1, r = 0, i = e.coordinates; r < i.length; r++) {
                                var o = i[r];
                                if (Wr(o, t, {ignoreEndVertices: !0}) && (n = !0), !Wr(o, t)) return !1
                            }
                            if (n) return !0;
                            return !1
                        }(n, r);
        ...
        return rt(t).type === rt(e).type && new Cs({precision: 6}).compare(tn(t), tn(e))
        ...
        if (new Cs({precision: 6}).compare(t, e)) return !1;
        var s = 0;
        switch (i) {
            case"MultiPoint":
        ...
        var r = e.weight, i = Fa(t, {weight: e.weight}), o = f([]);
        F(t, (function (t) {
            var e;
            o.features.push(En(t, {properties: {weight: null === (e = t.properties) || void 0 === e ? void 0 : e[r]}}))
        }));
        ...
        switch (void 0 === n && (n = {}), it(e)) {
            ...
            case"Polygon":
                ...
                var i, o, s, u, l, c, h, p, f = En(e, {properties: n.properties}), g = f.geometry.coordinates, d = 0,
            ...
            default:
                var x = de(e);
                return x ? t(x, {properties: n.properties}) : En(e, {properties: n.properties})
        }
        ...
        var r = new Ts.DBSCAN, i = r.run(G(t), N(e, n.units), n.minPoints, me), o = -1;
        ...
        var r = G(t), i = r.slice(0, e.numberOfClusters), o = zs(r, e.numberOfClusters, i), s = {};
        ...
        return i.load(o), t.features.forEach((function (t) {
            ...
            var e = Z(t), n = i.search({minX: e[0], minY: e[1], maxX: e[2], maxY: e[3]}), o = [];
        ...
        var n = rt(t), r = rt(e), i = t.properties || {}, o = $u.difference(n.coordinates, r.coordinates);
        ...
        return t = K(t), e = K(e), r = r || {}, i = i || 100, o = o || 10, new vi({x: t[0], y: t[1]}, {
            x: e[0],
            y: e[1]
        ...
        var s = Zi(t, {zProperty: r, flip: !0}), a = function (t, e, n) {
            for (var r = [], i = 1; i < e.length; i++) {
                var o = +e[i - 1], s = +e[i], a = Zo(Jo($i(t, o, s - o))), u = {};
                u.groupedRings = a, u[n] = o + "-" + s, r.push(u)
            }
            return r
        }(s, e, r);
        return f((a = function (t, e, n) {
            var r = Z(n), i = r[2] - r[0], o = r[3] - r[1], s = r[0], a = r[1], u = e[0].length - 1, l = e.length - 1,
        ...
        var n = e.inputField, r = e.threshold || 1e5, i = e.p || 2, o = e.binary || !1,
            s = ja(t, {alpha: e.alpha || -1, binary: o, p: i, standardization: e.standardization || !0, threshold: r}),
            a = [];
        F(t, (function (t) {
            var e = t.properties || {};
            a.push(e[n])
        ...
        for (var g = p[0], d = p[1], y = p[2], v = p[3], _ = r / me([g, d], [y, d], n) * (y - g), m = r / me([g, d], [g, v], n) * (v - d), x = y - g, E = v - d, b = Math.floor(x / _), w = Math.floor(E / m), I = (x - b * _) / 2, N = [], S = [], M = [], L = [], O = 1 / 0, R = 1 / 0, T = v - (E - w * m) / 2, A = 0; T >= d;) {
            for (var D = [], F = [], k = g + I, G = 0; k <= y;) {
                var q = a([k, T]), B = Js(q, s);
                D.push(B ? 0 : 1), F.push(k + "|" + T);
                var z = me(q, t);
                !B && z < O && (O = z, M = {x: G, y: A});
                var j = me(q, e);
                !B && j < R && (R = j, L = {x: G, y: A}), k += _, G++
            }
            S.push(D), N.push(F), T -= m, A++
        }
        var U = new Ys(S, {diagonal: !0}), V = U.grid[M.y][M.x], X = U.grid[L.y][L.x], Y = Xs.search(U, V, X), H = [u];
        ...
        var o = G(t).length, s = Fa(t, {weight: r}), a = 0, u = 0, l = 0;
        F(t, (function (t) {
            var e = t.properties[r] || 1, n = Ga(Q(t), Q(s));
        ...
        var m = Math.sqrt(2 * y / _), x = Math.sqrt(2 * v / _),
            E = Aa(s, m, x, {units: "degrees", angle: d, steps: n, properties: i}), b = _e(t, f([E])), w = {
