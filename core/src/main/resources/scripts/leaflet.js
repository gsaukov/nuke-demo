 ...
 */
const window = {screen: {devicePixelRatio: 1}};
const document = {documentElement: {style: {}},getElementsByTagName: function() { return [] },createElement: function() { return {} }};
const navigator = {userAgent: 'nodejs', platform: 'nodejs'};
